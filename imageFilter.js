            ...
            23: [
              function (t, r, n) {
                ...
                r.exports = function () {
                  ...
                  (T.RangeError = l.RangeError),
                    (T.CancellationError = l.CancellationError),
                    (T.TimeoutError = l.TimeoutError),
                    (T.OperationalError = l.OperationalError),
                    (T.RejectionError = l.OperationalError),
                    (T.AggregateError = l.AggregateError);
                  var h = function () {},
                    f = {},
                    d = { e: null },
                  ...
                  return (
                    ...
                    (T.prototype._isFollowingOrFulfilledOrRejected =
                      function () {
                    ...
                    (T.prototype._boundValue = function () {
                      var t = this._boundTo;
                      return void 0 !== t && t instanceof T
                        ? t.isFulfilled()
                          ? t.value()
                          : void 0
                        : t;
                    ...
                    (T.prototype._migrateCallbacks = function (t, e) {
                      var r = t._fulfillmentHandlerAt(e),
                        ...
                        o = t._promiseAt(e),
                        s = t._receiverAt(e);
                      o instanceof T && o._setIsMigrated(),
                        void 0 === s && (s = c),
                    ...
                    a.notEnumerableProp(T, "_makeSelfResolutionError", i),
                    t("./progress.js")(T, g),
                    t("./method.js")(T, h, _, s),
                    t("./bind.js")(T, h, _),
                    t("./finally.js")(T, d, _),
                    t("./direct_resolve.js")(T),
                    t("./synchronous_inspection.js")(T),
                    t("./join.js")(T, g, _, h),
                    (T.version = "2.11.0"),
                    (T.Promise = T),
                    t("./map.js")(T, g, s, _, h),
                    t("./cancel.js")(T),
                    t("./using.js")(T, s, _, m),
                    t("./generators.js")(T, s, h, _),
                    t("./nodeify.js")(T),
                    t("./call_get.js")(T),
                    t("./props.js")(T, g, _, s),
                    t("./race.js")(T, h, _, s),
                    t("./reduce.js")(T, g, s, _, h),
                    t("./settle.js")(T, g),
                    t("./some.js")(T, g, s),
                    t("./promisify.js")(T, h),
                    t("./any.js")(T),
                    ...
                    t("./timers.js")(T, h),
                    t("./filter.js")(T, h),
                    a.toFastProperties(T),
                    a.toFastProperties(T.prototype),
                    A({ a: 1 }),
                    A({ b: 2 }),
                    A({ c: 3 }),
                    A(1),
            ...
            38: [
              function (t, r, n) {
                ...
                var O = {
                    ...
                    isNode:
                      void 0 !== e && "[object process]" === S(e).toLowerCase(),
                  },
                  I;
                (O.isRecentNode =
                  O.isNode &&
  ...
  377: function (t, e, r) {
    ...
    (e.isDataURL = function (t) {
      ...
      (e.ImageUid = function (t, e) {
        return t ? { src: t } : { hash: e };
      });
  },
  585: function (t, e, r) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    (e.EXPLICIT_IMAGE_CONTENT_SCRIPT_TARGET = "EXPLICIT_IMAGE_CS"),
      (e.EXPLICIT_IMAGE_MODULE_TARGET = "EXPLICIT_IMAGE_MODULE");
  },
  586: function (t) {
    t.exports = {
  ...
  844: function (t, e, r) {
    ...
    function _(t, e, r) {
      if (l) {
        const n = e;
        if (n) {
          (n.style.border = "12px solid rgba(50, 255, 50, 0.5)"),
    ...
    function g(t, e) {
      if (l) {
        ...
        d(r).forEach((t) => {
          let r;
          c && t.setAttribute("data-gg-original-src", t.src),
            n ? (r = j(t)) : i && (r = j(t, i)),
            e && e(r);
        });
      }
        ...
        if (!!n.querySelectorAll(`[src="${u}"]`).length) m(n, e);
          ...
          const r = (function (t) {
            ...
            return (
              ...
              e.setAttribute(
                "style",
                "position:absolute; top:0; left:0; right:0; bottom:0; z-index:9998; color:white; width: 100%; height: 100%; opacity:0.75;"
              ),
              e
            );
          })(t);
    ...
    function b(t, e) {
      ...
      r.setAttribute(
        "style",
        `position:absolute; right:0; bottom:0; background-color:rgba(0, 0, 0, 0.7); z-index:9999; color:${n}; padding: 4px; font-size: initial; margin-bottom: 5px; margin-right: 4px;`
      ),
        r.classList.add("__gg-text-overlay");
    ...
    function j(t, e) {
      const r = t.parentNode;
      if (
        !(r && r.classList && r.classList.contains("__gg-overlay-container")) &&
        !p.has(t.src)
      ) {
        const r = document.createElement("div");
        (r.className = "__gg-overlay-container"),
          (r.style.display = "inline-block"),
          (r.style.position = "relative"),
          e ? r.setAttribute("id", e) : t.src && r.setAttribute("id", t.src);
        const n = document.createElement("div");
        return (
          (n.className = "__gg-overlay"),
          n.setAttribute(
            "style",
            "position:absolute; top:0; left:0; right:0; bottom:0; background-color:rgba(250, 245, 120, 0.85); z-index:9999; color:white; opacity: 0; pointer-events: none; transition: all .5s ease-in-out; -moz-transition: all .5s ease-in-out; -webkit-transition: all .5s ease-in-out; display: inline-block;"
          ),
          ...
          setTimeout(() => {
            null === n.nextSibling
              ? ((n.style.border = "12px solid rgba(100, 80, 80, 0.5)"),
                (n.style.backgroundColor = "rgba(0, 0, 0, 0)"))
              : ((n.style.border = "12px solid rgba(50, 255, 50, 0.5)"),
                (n.style.backgroundColor = "rgba(0, 0, 0, 0)"));
          }, 6e3),
    ...
    (() => {
      [...document.images].forEach((t) => {
        const { src: e } = t;
        (0, s.isDataURL)(e) &&
          (0, s.HashFromString)()(e).then(
            (r) => (
              t.setAttribute("data-gg-hash", r),
              setTimeout(() => {
                l && j(t, r);
                const a = {
                  type: n.default.INTERCEPTED_NEW_IMAGE,
                  payload: { image: (0, s.ImageUid)(void 0, r), base64data: e },
                };
        ...
        (function (t) {
          if (!h) {
            ...
            (h = new e(function (e) {
              e &&
                e.forEach((e) => {
                  const { addedNodes: r, type: n } = e;
                  if ("attributes" === n) {
                    const { target: r, attributeName: n } = e,
                      i = "IMG" === r.tagName || "image" === r.tagName,
                      o =
                        ("IMG" === r.tagName && r.src) ||
                        ("image" === r.tagName && r.getAttribute("xlink:href")),
                      s = o === u;
                    i && o && !s && t(r);
                  } else
                    "childList" === n &&
                      r.forEach((e) => {
                        const r = (function (t) {
                          if (t.getElementsByTagName) {
                            ...
                            return "IMG" === t.tagName || "image" === t.tagName
                              ? [...e, t]
                              : e;
                          }
                          return [];
          ...
          if (e) {
            ...
            if (r) {
              (void 0 !== r.classList &&
                r.classList.contains("__gg-overlay-container")) ||
                ((0, s.isDataURL)(e)
                  ? (0, s.HashFromString)()(e).then((e) => {
                      t.setAttribute("data-gg-hash", e),
                        setTimeout(() => {
                          l && j(t, e);
                          const r = {
                            type: n.default.INTERCEPTED_NEW_IMAGE,
                            payload: { image: (0, s.ImageUid)(void 0, e) },
                          };
                          i.default.runtime.sendMessage({
                            target: o.EXPLICIT_IMAGE_MODULE_TARGET,
                            action: r,
        ...
        i.default.runtime.onMessage.addListener((t, e, r) => {
          ...
          switch (i.type) {
            ...
            case n.default.IMAGE_PASSED_VALIDATION:
              !(function (t) {
                if (l) {
                  const { prediction: e, category: r } = t.payload,
                    i = e.imageUid;
                  if (!i) return;
                  const { src: o } = i,
                    s = `${r} (${e.prediction.toFixed(2)})`;
                  d(i).forEach((t) => {
                    c &&
                      (t.setAttribute("data-gg-original-src", t.src),
                      t.setAttribute("data-gg-prediction", e.prediction));
                    const r = t.nextSibling;
                    r && r.classList;
                    if (
                      r &&
                      r.classList &&
                      r.classList.contains("__gg-overlay")
                    )
                      _(t, r, s);
                    else {
                      const e = {
            ...
            case n.default.FOUND_NSFW_IMAGE:
              !(function (t) {
                const { prediction: e, category: r } = t.payload,
                  n = e.imageUid;
                if (!n) return;
                const { src: i } = e.imageUid;
                d(n).forEach((t) => {
                  if (
                    (c &&
                      (t.setAttribute("data-gg-original-src", i),
                      t.setAttribute("data-gg-prediction", e.prediction)),
                    l)
                  ) {
      ...
      const t = { type: n.default.GET_NSFW_IMAGE_URLS_FOR_TAB };
      i.default.runtime.sendMessage(
        { target: o.EXPLICIT_IMAGE_MODULE_TARGET, action: t },
        (t) => {
          if (void 0 !== t) {
              ...
              e &&
                e.forEach((t) => {
                  ...
                  ((function (t) {
                    ...
                    return (
                      (e.href = t), e.host && e.host != window.location.host
                    );
                  })((f = t))
                    ? w(f)
                    : E(f)
