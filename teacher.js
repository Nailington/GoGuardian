...
*/ var r = Object.getOwnPropertySymbols,
    ...
    (function (t, r) {
       ...
       */ (function () {
        ...
        var Dn = (function t(e) {
          var n,
            r = (e =
              null == e ? Ne : Dn.defaults(Ne.Object(), e, Dn.pick(Ne, xe)))
              .Array,
            o = e.Date,
            Zt = e.Error,
            te = e.Function,
          ...
          function Ir(t, e) {
            for (var n = t.length; n--; ) if (vs(t[n][0], e)) return n;
            return -1;
          }
          function Rr(t, e, n, r) {
            return (
          ...
          function Vr(t, e, n, r) {
            ...
            n && (e = nn(e, bn(n))),
              r
                ? ((i = en), (s = !1))
                : e.length >= a && ((i = En), (s = !1), (e = new wr(e)));
            t: for (; ++o < u; ) {
              var p = t[o],
                f = null == n ? p : n(p);
          ...
          (mr.templateSettings = {
            ...
            (_r.prototype = gr(yr.prototype)),
            (_r.prototype.constructor = _r),
            (br.prototype = gr(yr.prototype)),
            ...
            (Er.prototype.delete = function (t) {
              ...
              return !(
                n < 0 ||
                (n == e.length - 1 ? e.pop() : Be.call(e, n, 1), --this.size, 0)
              );
            }),
          ...
          function lo(t) {
            return (
              !(!Ps(t) || (he && he in t)) && (ks(t) ? ge : Kt).test(ha(t))
            );
          }
          function po(t) {
          ...
          function Co(t, e, n, r) {
            ...
            for (t === e && (e = ai(e)), n && (s = nn(t, bn(n))); ++i < a; )
              for (
                ...
                s !== t && Be.call(s, u, 1), Be.call(t, u, 1);
            return t;
          }
          function wo(t, e) {
          ...
          function gi(t, e, n, o, a, s, u, c, l, p) {
            var f = e & w,
              ...
              _ = d ? i : di(t);
            return function g() {
              for (var y = arguments.length, b = r(y), A = y; A--; )
                b[A] = arguments[A];
              if (v)
                var E = Ui(g),
                  C = (function (t, e) {
              ...
              return (
                ...
                c
                  ? (b = (function (t, e) {
                      for (
                        var n = t.length, r = Xn(e.length, n), o = ai(t);
                        r--;
                  ...
                  : m && y > 1 && b.reverse(),
                f && l < y && (b.length = l),
                this && this !== Ne && this instanceof g && (k = _ || di(k)),
                k.apply(x, b)
              );
            };
          }
          ...
          function xi(t) {
            ...
            return function (t, n) {
              if (((t = zs(t)), (n = null == n ? 0 : Xn(Hs(n), 292)))) {
                ...
                return +(
                  (r = (Ks(e(r[0] + "e" + (+r[1] + n))) + "e").split("e"))[0] +
                  "e" +
                  (+r[1] - n)
                );
              }
              ...
              (m &&
                (function (t, e) {
                  var n = t[1],
                    ...
                    a =
                      (r == w && n == b) ||
                      (r == w && n == x && t[7].length <= e[8]) ||
                      (r == (w | x) && e[7].length <= e[8] && n == b);
                  if (!i && !a) return t;
                  ...
                  (s = e[5]) &&
                    ...
                    (t[6] = u ? On(t[5], p) : e[6])),
                    (s = e[7]) && (t[7] = s),
                    r & w && (t[8] = null == t[8] ? e[8] : Xn(t[8], e[8])),
                    null == t[9] && (t[9] = e[9]),
                    (t[0] = e[0]),
                    (t[1] = o);
                })(k, m),
                ...
                e == b || e == A
                  ? (function (t, e, n) {
                      ...
                      return function a() {
                        ...
                        return (s -= p.length) < n
                          ? wi(t, e, gi, a.placeholder, i, u, p, i, i, n - s)
                          : $e(
          ...
          function ji(t, e, n, r, o, a) {
            return (
              Ps(t) && Ps(e) && (a.set(e, t), _o(t, e, i, ji, a), a.delete(e)),
              t
            );
          }
          function Oi(t) {
          ...
          var va = To(function (t, e) {
            ...
            ma = To(function (t, e) {
              var n = xa(e);
              return (
                Es(n) && (n = i), Es(t) ? Vr(t, Kr(e, 1, Es, !0), Fi(n, 2)) : []
              );
            }),
            ga = To(function (t, e) {
              var n = xa(e);
              return (
                Es(n) && (n = i), Es(t) ? Vr(t, Kr(e, 1, Es, !0), i, n) : []
              );
            });
          function ya(t, e, n) {
          ...
          var ja = To(function (t) {
            ...
            Ia = To(function (t) {
              var e = xa(t);
              return (
                (e = "function" == typeof e ? e : i), Vo(Kr(t, 1, Es, !0), i, e)
              );
            });
          function Ra(t) {
          ...
          return (
            ...
            (mr.difference = va),
            (mr.differenceBy = ma),
            (mr.differenceWith = ga),
            (mr.drop = function (t, e, n) {
              var r = null == t ? 0 : t.length;
              return r
            ...
            (mr.groupBy = Xa),
            (mr.initial = function (t) {
              return null != t && t.length ? No(t, 0, -1) : [];
            }),
            (mr.intersection = Ea),
            (mr.intersectionBy = Ca),
            (mr.intersectionWith = wa),
            (mr.invert = ru),
            (mr.invertBy = ou),
            (mr.invokeMap = Ga),
            (mr.iteratee = Ru),
            ...
            (mr.toPairs = hu),
            (mr.toPairsIn = du),
            (mr.toPath = function (t) {
              return _s(t) ? nn(t, fa) : Ds(t) ? [t] : ai(pa(Ks(t)));
            }),
            (mr.toPlainObject = Ys),
            (mr.transform = function (t, e, n) {
              var r = _s(t),
                o = r || Cs(t) || Us(t);
              if (((e = Fi(e, 4)), null == n)) {
            ...
            (mr.unzip = Ra),
            (mr.unzipWith = Na),
            (mr.update = function (t, e, n) {
              return null == t ? t : Ho(t, e, Xo(n));
            }),
            (mr.updateWith = function (t, e, n, r) {
              return (
                (r = "function" == typeof r ? r : i),
                null == t ? t : Ho(t, e, Xo(n), r)
              );
            }),
            (mr.values = vu),
            (mr.valuesIn = function (t) {
              return null == t ? [] : An(t, su(t));
            }),
            (mr.without = Ma),
            (mr.words = ku),
            (mr.wrap = function (t, e) {
              return fs(Xo(e), t);
            }),
            (mr.xor = Ba),
            (mr.xorBy = Da),
            ...
            (mr.deburr = yu),
            (mr.defaultTo = function (t, e) {
              return null == t || t != t ? e : t;
            }),
            (mr.divide = $u),
            (mr.endsWith = function (t, e, n) {
              (t = Ks(t)), (e = Lo(e));
              var r = t.length,
            ...
            (mr.find = za),
            (mr.findIndex = ya),
            (mr.findKey = function (t, e) {
              return cn(t, Fi(e, 3), Gr);
            }),
            (mr.findLast = Ya),
            (mr.findLastIndex = _a),
            (mr.findLastKey = function (t, e) {
              return cn(t, Fi(e, 3), Qr);
            }),
            (mr.floor = Xu),
            (mr.forEach = Ka),
            (mr.forEachRight = $a),
            (mr.forIn = function (t, e) {
            ...
            (mr.head = Aa),
            (mr.identity = Iu),
            (mr.includes = function (t, e, n, r) {
              (t = As(t) ? t : vu(t)), (n = n && !r ? Hs(n) : 0);
              var o = t.length;
              return (
                n < 0 && (n = $n(o + n, 0)),
                Bs(t) ? n <= o && t.indexOf(e, n) > -1 : !!o && pn(t, e, n) > -1
              );
            }),
            ...
            (mr.isArrayBuffer = bs),
            (mr.isArrayLike = As),
            (mr.isArrayLikeObject = Es),
            (mr.isBoolean = function (t) {
              return !0 === t || !1 === t || (js(t) && eo(t) == q);
            }),
            (mr.isBuffer = Cs),
            (mr.isDate = ws),
            (mr.isElement = function (t) {
            ...
            (mr.kebabCase = _u),
            (mr.last = xa),
            (mr.lastIndexOf = function (t, e, n) {
              var r = null == t ? 0 : t.length;
              if (!r) return -1;
              var o = r;
              return (
                n !== i && (o = (o = Hs(n)) < 0 ? $n(r + o, 0) : Xn(o, r - 1)),
                e == e
                  ? (function (t, e, n) {
            ...
            (mr.repeat = function (t, e, n) {
              return (
                (e = (n ? Gi(t, e, n) : e === i) ? 1 : Hs(e)), ko(Ks(t), e)
              );
            }),
            (mr.replace = function () {
              var t = arguments,
            ...
            (mr.startCase = Cu),
            (mr.startsWith = function (t, e, n) {
              return (
                (t = Ks(t)),
                (n = null == n ? 0 : Dr(Hs(n), 0, t.length)),
                (e = Lo(e)),
            ...
            (mr.toInteger = Hs),
            (mr.toLength = qs),
            (mr.toLower = function (t) {
              return Ks(t).toLowerCase();
            }),
            (mr.toNumber = zs),
            (mr.toSafeInteger = function (t) {
              return t ? Dr(Hs(t), -N, N) : 0 === t ? t : 0;
            }),
            (mr.toString = Ks),
            (mr.toUpper = function (t) {
              ...
              if ((s && (u += c.length - u), Ns(o))) {
                if (t.slice(u).search(o)) {
                  var l,
                    p = c;
                  for (
                    o.global || (o = re(o.source, Ks(qt.exec(o)) + "g")),
                      o.lastIndex = 0;
                    (l = o.exec(p));
              ...
              o &&
                (mr.prototype[e] = function () {
                  ...
                  if (!a && l) {
                    ...
                    var m = t.apply(e, s);
                    return (
                      m.__actions__.push({ func: Wa, args: [p], thisArg: i }),
                      new _r(m, f)
                    );
                  }
                  return d && v
            ...
            (sr[gi(i, y).name] = [{ name: "wrapper", func: i }]),
                ...
                n.exports = function () {
                  ...
                  o.inherits(c, Error),
                    ...
                    (c.fireRejectionEvent = function (t, e, n, o) {
                      ...
                      if (v)
                        try {
                          s = v(t.toLowerCase(), { reason: n, promise: o });
                        } catch (t) {
                          (s = !0), r.throwLater(t);
                        }
                      a ||
              ...
              function (t, e, n) {
                ...
                for (
                  ...
                  "function" == typeof Array.prototype[v[m]] &&
                    (d.prototype[v[m]] = Array.prototype[v[m]]);
                  ...
                  return (
                    ...
                    (x.prototype._migrateCallbacks = function (t, e) {
                      var n = t._fulfillmentHandlerAt(e),
                        ...
                        i = t._promiseAt(e),
                        a = t._receiverAt(e);
                      i instanceof x && i._setIsMigrated(),
                        void 0 === a && (a = u),
                    ...
                    s.notEnumerableProp(x, "_makeSelfResolutionError", o),
                    t("./progress.js")(x, m),
                    t("./method.js")(x, f, v, a),
                    t("./bind.js")(x, f, v),
                    t("./finally.js")(x, d, v),
                    ...
                    t("./cancel.js")(x),
                    t("./using.js")(x, a, v, _),
                    t("./generators.js")(x, a, f, v),
                    t("./nodeify.js")(x),
                    t("./call_get.js")(x),
                    t("./props.js")(x, m, v, a),
                    t("./race.js")(x, f, v, a),
                    t("./reduce.js")(x, m, a, v, f),
                    t("./settle.js")(x, m),
                    t("./some.js")(x, m, a),
                    t("./promisify.js")(x, f),
                    t("./any.js")(x),
                    ...
                    t("./timers.js")(x, f),
                    t("./filter.js")(x, f),
                    s.toFastProperties(x),
                    s.toFastProperties(x.prototype),
                    k({ a: 1 }),
                    k({ b: 2 }),
                    k({ c: 3 }),
                    k(1),
                    ...
                    k(!1),
                    k(new x(f)),
                    g.setBounds(c.firstLineError, s.lastLineError),
                    x
                  );
                };
              },
                        ...
                        for (
                          ...
                          if (2 !== (i = f[m])) {
                            ...
                            if (
                              ...
                              this._promise._pushContext(),
                              u
                                ? (s.push(t), (h = c(d).call(v, t, m, a)))
                                : (h = c(d).call(v, this._accum, t, m, a)),
                            ...
                            if (g instanceof e) {
                              if ((g = g._target())._isPending())
                                return (
                                  (f[m] = 4), g._proxyPromiseArray(this, m)
                                );
                              if (!g._isFulfilled())
  ...
  function (t, e, n) {
    ...
    (l.createElement = function (t, e, n) {
      ...
      (l.cloneElement = function (t, e, n) {
        ...
        if (null != e)
          for (a in (u(e) && ((d = e.ref), (v = o.current)),
          c(e) && (h = "" + e.key),
  ...
  function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    (e.SET_ACTIVE_CHAT_CLASSROOM_SESSIONS =
      "SET_ACTIVE_CHAT_CLASSROOM_SESSIONS"),
      (e.SET_ACTIVE = "SET_ACTIVE"),
      (e.SET_CHAT_PANEL_ACTIVE = "SET_CHAT_PANEL_ACTIVE"),
      (e.SET_TEACHER_CHAT_UPDATES_PHASE_1 = "SET_TEACHER_CHAT_UPDATES_PHASE_1"),
      (e.SET_CLASSROOM_SESSIONS = "SET_CLASSROOM_SESSIONS"),
      (e.SET_ENABLED = "SET_ENABLED"),
      (e.ACK_MESSAGES = "ACK_MESSAGES"),
      (e.ADD_MESSAGE = "ADD_MESSAGE"),
      (e.REMOVE_MESSAGES = "REMOVE_MESSAGES"),
      (e.SET_MESSAGES = "SET_MESSAGES"),
      (e.CLEAR_MESSAGES = "CLEAR_MESSAGES"),
      (e.SET_PROFILE = "SET_PROFILE"),
      (e.SEND_MESSAGE = "SEND_MESSAGE"),
      (e.ACCEPT_PRIORITY_MESSAGE = "ACCEPT_PRIORITY_MESSAGE"),
      (e.SET_CHAT_BUBBLE_POSITION = "SET_CHAT_BUBBLE_POSITION"),
      (e.SET_APP_AND_EXTENSION_IDS = "SET_APP_AND_EXTENSION_IDS");
  },
  function (t, e) {
    var n = Array.isArray;
    t.exports = n;
          ...
          a = (function (n) {
            ...
            return (
              ...
              (a.prototype.addExtraProps = function (t) {
                if (!(x || d || (this.propsMode && this.subscription)))
                  return t;
                var e = g({}, t);
                return (
        ...
        return (
          ...
          m && g
            ...
            ? (t.dependsOnOwnProps && (p = t(c, l)),
              ...
              (h = n(p, f, l)))
            : g
            ? ((d = t(c, l)), (v = !s(d, p)), (p = d), v && (h = n(p, f, l)), h)
            : h
        );
      }
      return function (o, i) {
  ...
  function (t, e, n) {
    ...
    function j(t, e, n) {
      for (
        0,
          ...
          e.nodeType === w && (e = e.documentElement);
        e.lastChild;
    ...
    function I(t) {
      return !(
        !t ||
        (t.nodeType !== C && t.nodeType !== w && t.nodeType !== x)
      );
    }
    function R(t) {
      var e = (function (t) {
    ...
    var B = {
      ...
      renderSubtreeIntoContainer: function (t, e, n, o) {
        return (
          (null != t && f.has(t)) || r("38"),
          B._renderSubtreeIntoContainer(t, e, n, o)
        );
      },
...
*/
        ...
        updateComponent: function (t, e, n, o, i) {
          ...
          this._pendingForceUpdate ||
            (a.shouldComponentUpdate
              ...
              : this._compositeType === m && (f = !h(c, l) || !h(a.state, p))),
            (this._updateBatchNumber = null),
            f
              ? ((this._pendingForceUpdate = !1),
            ...
            for (f in e)
              if (e.hasOwnProperty(f)) {
                var d = (h = t && t[f]) && h._currentElement,
                  v = e[f];
                if (null != h && i(d, v))
                  r.receiveComponent(h, v, s, l), (e[f] = h);
                else {
            ...
            for (l in s)
              if (s.hasOwnProperty(l)) {
                var m = r && r[l],
                  g = s[l];
                m === g
                  ? ((p = u(p, this.moveChild(m, v, f, h))),
                    (h = Math.max(m._mountIndex, h)),
                    (m._mountIndex = f))
                  : (m && (h = Math.max(m._mountIndex, h)),
                    (p = u(p, this._mountChildAtIndex(g, a[d], v, f, e, n))),
                    d++),
                  f++,
                  (v = i.getHostNode(g));
              }
  ...
  function (t, e, n) {
    ...
    function V() {
      ...
      switch ((t || r("64"), this._tag)) {
        ...
        case "video":
        case "audio":
          for (var e in ((this._wrapperState.listeners = []), F))
            F.hasOwnProperty(e) &&
              this._wrapperState.listeners.push(h.trapBubbledEvent(e, F[e], t));
          break;
        case "source":
          this._wrapperState.listeners = [
          ...
          for (r in e) {
            ...
            if (e.hasOwnProperty(r) && p !== f && (null != p || null != f))
              if ("style" === r)
                ...
                p ? N(this, r, p, n) : f && x(this, r);
              else if (X(this._tag, e))
    ...
    function E(t, e, n, o) {
      ...
      if (
        (l
          ...
          : A
          ? _(t, n) && (s = g.compositionEnd)
          : (function (t, e) {
              return "topKeyDown" === t && e.keyCode === c;
            })(t, n) && (s = g.compositionStart),
        !s)
      )
        return null;
      d &&
        (A || s !== g.compositionStart
          ? s === g.compositionEnd && A && (u = A.getData())
          : (A = i.getPooled(o)));
    ...
    t.exports = {
      inject: function () {
        E ||
          ...
          g.HostComponent.injectTextComponentClass(d),
  ...
  function (t, e, n) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (e.setActive = function (t) {
        return { type: r.SET_ACTIVE, payload: t };
      }),
      (e.setChatPanelActive = function (t) {
        return { type: r.SET_CHAT_PANEL_ACTIVE, payload: t };
      }),
      (e.setTeacherExtensionChatUpdatesPhase1 = function (t) {
        return { type: r.SET_TEACHER_CHAT_UPDATES_PHASE_1, payload: t };
      });
    var r = n(103);
  },
  ,
          ...
          for (
            ...
            for (var _ in d)
              if (d.hasOwnProperty(_)) {
                var b = d[_];
                if ("number" == typeof b)
                  (v[_] = b), (m[_] = 0), (g[_] = b), (y[_] = 0);
                else {
                  for (
                    var A = t.state.lastIdealStyles[h][_],
  ...
  function (t, e, n) {
    (e = t.exports = n(65)(!0)).push([
      ...
      "",
      {
        version: 3,
        sources: [
          "/liminex/extensions/monitor/src/content-scripts/teacher/chat/components/app/chatModal.scss",
        ],
        names: [],
        mappings:
    ...
    class s extends r.Component {
      constructor(...t) {
        ...
        return (
          ...
          (this.state = { isOpen: !1, animate: !1, previousFocus: null }),
          ...
          (this.closeAnnouncement = () => {
            this.props.ackMessages([this.props.message]),
              this.state.previousFocus &&
                this.state.previousFocus instanceof HTMLElement &&
                this.state.previousFocus.focus(),
              this.setState({ isOpen: !1, animate: !1, previousFocus: null });
          }),
          (this.onKey = (t) => {
      ...
      componentDidMount() {
        this.props.message && this.openAnnouncement(),
      ...
      componentWillUpdate(t) {
        t.message && !this.state.isOpen
          ? this.openAnnouncement()
          : !t.message && this.state.isOpen && this.closeAnnouncement();
      }
      render() {
        const { classroomName: t, message: e } = this.props;
        let n = "",
        ...
        return (
          this.state.animate &&
            ((n = e.payload.content),
            (r += ` ${i.default.chatWrapperShow}`),
            (a += ` ${i.default.chatModalShow}`),
            (s += ` ${i.default.chatBackgroundShow}`)),
  ...
  function (t, e, n) {
    (e = t.exports = n(65)(!0)).push([
      ...
      "",
      {
        version: 3,
        sources: [
          "/liminex/extensions/monitor/src/content-scripts/teacher/chat/components/app/chatPreview.scss",
        ],
        names: [],
        mappings:
    ...
    (e.default = class extends r.Component {
      render() {
        ...
        return o.default.createElement(
          "div",
          { className: t, "aria-live": "polite", role: "log" },
          o.default.createElement(
            "p",
            { className: a.default.sessionName, "aria-hidden": "true" },
            this.props.classroomName
          ),
          o.default.createElement(
            "p",
            { className: a.default.message, "aria-hidden": "true" },
            this.props.message
          ),
  ...
  function (t, e, n) {
    (e = t.exports = n(65)(!0)).push([
      ...
      "",
      {
        version: 3,
        sources: [
          "/liminex/extensions/monitor/src/content-scripts/teacher/chat/components/app/chatBubble.scss",
        ],
        names: [],
        mappings:
  ...
  function (t, e, n) {
    ...
    (e.default = class extends r.Component {
      constructor(t) {
        super(t),
          (this.toggleChatBubbleAnimation = () => {
            this.state.isAnimatingChatBubble
              ? (clearTimeout(this._animateChatBubble),
                clearTimeout(this._cycleAnimationStage))
          ...
          (this.cycleChatBubbleAnimations = () => {
            this._cycleAnimationStage = setTimeout(
              this.cycleChatBubbleAnimations,
              l[this.state.animationStage].delay
            );
            let t = this.state.animationStage + 1;
            5 === t && (t = 0), this.setState({ animationStage: t });
          }),
          (this.handleChatBubbleClick = () => {
            this.state.isAnimatingChatBubble &&
              this.toggleChatBubbleAnimation(),
              this.props.setActive &&
                this.props.setActive({ open: !0, focus: !0 });
          }),
          (this.state = { animationStage: 0, isAnimatingChatBubble: !1 }),
          (this.toggleChatBubbleAnimation =
            this.toggleChatBubbleAnimation.bind(this)),
          (this.handleChatBubbleClick = this.handleChatBubbleClick.bind(this));
      }
      componentDidMount() {
        this.props.unreadCount &&
          (this._animateChatBubble = setTimeout(
            this.toggleChatBubbleAnimation,
            c
          ));
      }
      ...
      componentDidUpdate(t, e) {
        const { unreadCount: n } = this.props,
          { isAnimatingChatBubble: r } = this.state;
        !r && n > 0 && t.unreadCount !== n
          ? (this._animateChatBubble = setTimeout(
              this.toggleChatBubbleAnimation,
              c
            ))
          : r && !n && this.toggleChatBubbleAnimation();
      }
      render() {
        let { unreadCount: t } = this.props,
          e = t ? s.default.count : "",
          n = (0, i.default)(s.default.chatBubble, {
            [s.default.hasPreview]: this.props.isPreviewActive,
          });
        return o.default.createElement(
          a.Motion,
          { style: { x: l[this.state.animationStage].value } },
          ({ x: r }) =>
            o.default.createElement(
              "button",
              {
                ...
                style: { transform: `translate3d(${r}px, 0, 0)` },
              },
              o.default.createElement(
                "div",
  ...
  function (t, e, n) {
    (e = t.exports = n(65)(!0)).push([
      ...
      "",
      {
        version: 3,
        sources: [
          "/liminex/extensions/monitor/src/content-scripts/teacher/chat/components/print.scss",
        ],
        names: [],
      ...
      (e.locals = { noPrint: "_2h_KVyxaj61YqtR-UBnwYR" });
  },
  function (t, e, n) {
    var r = n(857);
    "string" == typeof r && (r = [[t.i, r, ""]]);
  ...
  function (t, e, n) {
    ...
    class y extends o.Component {
        ...
        super(t),
          ...
          (this._handleMouseDown = (t) => {
            ...
            this.setState({ mouseInset: i, isDragging: !0 }),
              ...
              (this._dragTimeout = setTimeout(() => {
                this.setState({ childClickable: !1 });
              }, 250));
          }),
          ...
          (this._handleMouseUp = (t) => {
            ...
            const { top: e, left: n } = this.state.position,
              r = this._returnPositionName(n, e);
            this.props.setChatBubblePosition({ posName: r }),
              this.setState({
                isDragging: !1,
                childClickable: !0,
                mouseInset: { x: 0, y: 0 },
      ...
      componentWillReceiveProps(t) {
        ...
        r.posName &&
          n.posName !== r.posName &&
          ((e.position = this._returnPositionCoords(r.posName)),
        ...
        if (
          ...
          (clearTimeout(this.state.previewTimeout),
          (e.previewTimeout = null),
          (e.previewClassroomName = ""),
          Date.now() - i.timeChanged < m)
        ) {
          let t = this.props.classroomSessions.find(
            (t) => t.id === i.sessionId
          );
          t &&
            ((e.previewClassroomName = t.classroomName),
            (e.previewTimeout = setTimeout(this._clearPreview, m)));
        }
        this.setState(e),
      ...
      render() {
        let {
          ...
          { isDragging: a, positionName: s, childClickable: c } = this.state;
        if (!t || !e.length) return i.default.createElement("div", null);
        let p = !0;
        s && (p = "left" === s.split("-")[1]);
        let v =
            !!n.totalUnreadCount &&
            !!this.state.previewTimeout &&
            "message" === n.newestMessage.type,
        ...
        if (a) y = this.state.position;
          ...
          y = { top: (0, u.spring)(t), left: (0, u.spring)(e) };
        }
        return i.default.createElement(
          ...
          !this.props.teacherExtensionChatUpdatesPhase1 &&
            i.default.createElement(
              u.Motion,
              { style: y },
              (t) => (
                Object.keys(y).length || (t = {}),
                i.default.createElement(
                  "div",
                  {
                    ref: "chatWrap",
    ...
    const _ = {
      ...
      ackMessages: (t) => ({ type: "ACK_MESSAGES", payload: t }),
      setChatBubblePosition: (t) => ({
    ...
    (e.default = (0, s.connect)((t) => {
      ...
      return (
        Object.keys(t).length &&
          (e = t.classroomSessions.filter((e) =>
            t.activeChatClassroomSessions.find((t) => t.sessionId === e.id)
          )),
        {
          ...
          teacherExtensionChatUpdatesPhase1: c.default.get(
            t,
            "active.teacherExtensionChatUpdatesPhase1",
            !1
          ),
        }
      );
  ...
  function (t, e, n) {
    ...
    if (document.querySelectorAll("[data-gg-chat-anchor]").length)
      console.warn(
        "Trying to append chat bubble anchor, but an anchor already exists."
      );
    else {
