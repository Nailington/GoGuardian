!(function (t) {
        ...
        })(
          {
              ...
              function (t, r, n) {
                ...
                r.exports = function () {
                  ...
                  var h = function () {},
                    f = {},
                    d = { e: null },
                    _ = t("./thenables.js")(x, h),
                    g = t("./promise_array.js")(x, h, _, s),
                    v = t("./captured_trace.js")(),
                    y = t("./debuggability.js")(x, v),
                    m = t("./context.js")(x, v, y),
                  ...
                  return (
                    ...
                    t("./cancel.js")(x),
                    t("./using.js")(x, s, _, m),
                    t("./generators.js")(x, s, h, _),
                    t("./nodeify.js")(x),
                    t("./call_get.js")(x),
                    t("./props.js")(x, g, _, s),
                    t("./race.js")(x, h, _, s),
                    t("./reduce.js")(x, g, s, _, h),
                    t("./settle.js")(x, g),
                    t("./some.js")(x, g, s),
                    t("./promisify.js")(x, h),
                    t("./any.js")(x),
            ...
            38: [
              function (t, r, n) {
                ...
                (R.isRecentNode =
                  R.isNode &&
                  ((D = e.versions.node.split(".").map(Number)),
                  (0 === D[0] && D[1] > 10) || D[0] > 0)),
  ...
  50: function (t, e, r) {
    (function (t, n) {
      ...
      function l(t, r, n) {
        ...
        return (
          m(r) && (j = " " + RegExp.prototype.toString.call(r)),
          b(r) && (j = " " + Date.prototype.toUTCString.call(r)),
          w(r) && (j = " " + p(r)),
        ...
        if (
          ...
          a ||
            (t.seen.indexOf(c.value) < 0
              ? (a = _(r) ? l(t, c.value, null) : l(t, c.value, r - 1)).indexOf(
                  "\n"
                ) > -1 &&
                (a = o
                  ? a
      ...
      function m(t) {
        return j(t) && "[object RegExp]" === E(t);
      }
      function j(t) {
        return "object" == typeof t && null !== t;
      }
      function b(t) {
        return j(t) && "[object Date]" === E(t);
      }
      function w(t) {
        return j(t) && ("[object Error]" === E(t) || t instanceof Error);
      }
      function k(t) {
        return "function" == typeof t;
      }
  ...
  872: function (t, e, r) {
    ...
    const a = "gg_youtube_injection";
    class c {
      constructor() {
        (this.healthCheck = (t, e, r) => {
          "youtube-content-script-status" === t.type &&
            (this.verifyInjectionHealth(), r("ok"));
        }),
          (this.onPortMessage = (t) => {
            window.dispatchEvent(u(t));
          }),
          (this.handleInjectionMessage = (t) => {
            const { action: e } = t.detail;
            "INJECTION_HEALTHY" === e.type
              ? (this.injectionHealthy = !0)
              : this.port.postMessage(e);
          }),
          (this.onPortDisconnect = () => {
            window.removeEventListener(
              "GG_YT_MSG_FROM_PAGE",
              this.handleInjectionMessage
            ),
              this.removeExistingInjection(),
              this.port.onMessage.removeListener(this.onPortMessage),
              this.port.onDisconnect.removeListener(this.onPortDisconnect),
              delete this.port,
              window.self === window.top &&
                n.default.runtime.onMessage.removeListener(this.healthCheck);
          }),
          (this.port = n.default.runtime.connect({ name: "youtube" })),
          ...
          this.injectContextScript(),
          window.self === window.top &&
            n.default.runtime.onMessage.addListener(this.healthCheck);
      }
      injectContextScript() {
        this.removeExistingInjection(), (this.injectionHealthy = !1);
        const t = document.createElement("script");
        (t.id = a),
          (t.src = n.default.runtime.getURL("youtube_injection.js")),
          document.head && document.head.appendChild(t);
      }
      removeExistingInjection() {
        window.dispatchEvent(u({ type: "DESTROY" }));
        const t = document.getElementById(a);
        t && document.head && document.head.removeChild(t);
      }
      verifyInjectionHealth() {
        var t = this;
        return s(function* () {
          try {
            yield (0, i.default)(
              s(function* () {
                if (!t.injectionHealthy) throw new Error();
              }),
              1e3,
              3
            );
          } catch (e) {
            t.injectContextScript();
          }
        })();
      }
    }
    function u(t) {
      return new CustomEvent("GG_YT_MSG_FROM_CS", { detail: { action: t } });
    }
    (e.YouTubeContentScript = c), new c();
  },
});
