!(function (t) {
    ...
    (function (t, n) {
       ...
       */ (function () {
        ...
        var Lr = (function t(e) {
          ...
          function Cn(t, e) {
            for (var r = t.length; r--; ) if (ga(t[r][0], e)) return r;
            return -1;
          }
          function In(t, e, r, n) {
            return (
          ...
          return (
            ...
            (vn.throttle = function (t, e, r) {
              ...
              return (
                ...
                sa(t, e, { leading: n, maxWait: e, trailing: i })
              );
            }),
            (vn.thru = qs),
            (vn.toArray = za),
            ...
            Qe(["filter", "map", "takeWhile"], function (t, e) {
              ...
              bn.prototype[t] = function (t) {
                var e = this.clone();
                return (
                  e.__iteratees__.push({ iteratee: Do(t, 3), type: r }),
              ...
              i &&
                (vn.prototype[e] = function () {
                  ...
                  if (!s && l) {
                    ...
                    var v = t.apply(e, a);
                    return (
                      v.__actions__.push({ func: qs, args: [f], thisArg: o }),
                      new mn(v, h)
                    );
                  }
                  return d && g
            ...
            Qn(bn.prototype, function (t, e) {
              ...
              if (r) {
                var n = r.name + "";
                (an[n] || (an[n] = [])).push({ name: e, func: r });
              }
            }),
            (an[_o(o, y).name] = [{ name: "wrapper", func: o }]),
                ...
                r.exports = function () {
                  ...
                  i.inherits(c, Error),
                    ...
                    (c.fireRejectionEvent = function (t, e, r, i) {
                      ...
                      if (g)
                        try {
                          a = g(t.toLowerCase(), { reason: r, promise: i });
                        } catch (t) {
                          (a = !0), n.throwLater(t);
                        }
                      s ||
              ...
              function (t, r, n) {
                ...
                r.exports = function () {
                  ...
                  return (
                    ...
                    t("./cancel.js")(x),
                    t("./using.js")(x, s, g, m),
                    t("./generators.js")(x, s, h, g),
                    t("./nodeify.js")(x),
                    t("./call_get.js")(x),
                    t("./props.js")(x, v, g, s),
                    t("./race.js")(x, h, g, s),
                    t("./reduce.js")(x, v, s, g, h),
                    t("./settle.js")(x, v),
                    t("./some.js")(x, v, s),
                    t("./promisify.js")(x, h),
                    t("./any.js")(x),
    ...
    (function (t) {
      ...
      function d(t) {
        ...
        return c(
              ...
              c(
                c(
                  c(
                    c(
                      c(
                        { orgID: _, originalURL: y, sourceType: w, reason: j },
                        A && { siteCategoryID: A }
                      ),
                      x && { adminPolicyID: x }
                    ),
          ...
          !!O.length && { teacherSessionAdminNames: O }
        );
      }
      var g,
        v,
      ...
      (e.SourceType = void 0),
        ((g = e.SourceType || (e.SourceType = {})).ChromiumM = "chromium-m"),
        (g.CIP = "cip"),
        (g.NA = "na"),
        (g.Unknown = "unknown"),
        (e.Reason = void 0),
        ...
        var c = n ? "https" : "http",
          ...
          p = (function (e) {
            ...
            s && d.append("sci", s.toString()),
              a && d.append("api", a.toString()),
              u && d.append("afi", u.toString()),
            ...
            return { ctx: g, sum: M(g).toString(16).padStart(8, "0") };
          })(i),
          d = p.ctx,
          g = p.sum;
        return (
          h.searchParams.append(y.Ctx, d), h.searchParams.append(y.Sum, g), h
        );
      }),
  ...
  361: function (t, e, r) {
    ...
    let i = (e.blockTabWithUrl =
      ((o = p(function* (t, e) {
        return (0,
        f.default)(l.default.tabs.updateAsync.bind(l.default, t, { url: e.toString() }), null, 5);
      })),
      function (t, e) {
    ...
    let a = (e.blockSubFrameWithUrl =
      ((u = p(function* (t, e, r) {
        return (0,
        f.default)(l.default.tabs.sendMessageAsync.bind(l.default, t, { target: "BlockSubFrame", url: r }, { frameId: e }), null, 5);
      })),
      function (t, e, r) {
    ...
    function g(t, e, r) {
      return c.default.format({
        ...
        query: { oI: t && 1234567 * t, type: "chromium-m", url: e },
      });
    }
  },
  48: function (t, e, r) {
        ...
        if (
          ...
          a ||
            (t.seen.indexOf(u.value) < 0
              ? (a = g(r) ? l(t, u.value, null) : l(t, u.value, r - 1)).indexOf(
                  "\n"
                ) > -1 &&
                (a = o
                  ? a
  ...
  606: function (t, e, r) {
    "use strict";
    (e.decode = e.parse = r(605)), (e.encode = e.stringify = r(604));
  },
  607: function (t, e, r) {
    "use strict";
    t.exports = {
      ...
      /*! https://mths.be/punycode v1.4.1 by @mathias */ !(function (o) {
        ...
        function C(t) {
          var e,
            ...
            x,
            k = [];
          for (m = (t = R(t)).length, e = g, r = 0, o = d, s = 0; s < m; ++s)
    ...
    (s.GET_SEARCH_TERMS = /google\..+[#&?]q=([^&]+)/g),
      (s.run = function () {
        ...
        if (
          ...
          if (e && e[1]) {
            var r = e[1].replace(/\+/g, " ");
            (r = decodeURIComponent(r)), t.push({ searchTerms: r, isNew: !0 });
          }
        }
        return this.shouldRunAgain(t)
          ? ((this._metadata = t),
            i.default.resolve({ metadataType: "searches", metadata: t }))
          : i.default.resolve();
      });
  ...
  876: function (t, e, r) {
    ...
    var l = {
      ...
      allMetadata: { flaggedActivity: [], searches: [], docs: [] },
      _scripters: {
      ...
      _resetMetadata() {
        this.allMetadata = { flaggedActivity: [], searches: [], docs: [] };
      },
    };
        ...
        e.addEventListener("click", function () {
          ...
          (s.className = "btn submitAll btn-default"),
            ...
            s.addEventListener("click", function () {
              ...
              const a = o.default.runtime.connect({ name: "bypass" });
              a.onMessage.addListener(({ response: e }) => {
                ...
                a.postMessage({ type: "bypass", url: i, pw: r });
            }),
            t.appendChild(s);
        }),
        t.appendChild(e);
