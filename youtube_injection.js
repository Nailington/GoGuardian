      ...
      verifyPlayerMethods() {
        ...
        e.length > 0 &&
          window.dispatchEvent(
            (0, a.MsgToCS)({
              type: "COLLECT_METRIC",
              payload: { metric: "player_api.missing_methods", tags: e },
            })
          );
      }
      cleanup() {
    ...
    t.YouTubeInjection = class {
      constructor() {
        (this.handleCSMessage = (e) => {
          ...
          window.dispatchEvent((0, a.MsgToCS)({ type: "SETTINGS_REQUEST" })),
          window.dispatchEvent((0, a.MsgToCS)({ type: "INJECTION_HEALTHY" }));
      }
      configure(e) {
        this.settings = e;
        const {
